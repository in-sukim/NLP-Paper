...
region-level에서의 능력을 향상시키기 위해 Kosmos-2, Shikra, PVIT, GPT4RoI 및 GLaMM등의 최근 실험에서는 bounding box 경계를 설정하고 <br/>object-level에서 공간적 특징을 활용하여 visual instruction tuning을 시도.
